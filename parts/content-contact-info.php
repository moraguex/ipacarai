<div class="contact-info">
	...
	<address><span class="fa fa-phone" aria-hidden="true"></span> <span><?php echo __('Tel&eacute;fonos: ', 'ipacaraiwp'); the_field('phone-number'); ?></span><br><span><?php echo __('Fax: ', 'ipacaraiwp'); the_field('fax'); ?></span></address>
