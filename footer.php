  <footer class="main-footer" role="contentinfo">
	    ...
	    <div class="container">
				<div class="row footer-logos">
					<div class="col-xs-6 col-sm-4"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/ipacarai-logo.jpg" class="img-responsive ipacarai-logo" alt="Ipacarai Logo"></div>
